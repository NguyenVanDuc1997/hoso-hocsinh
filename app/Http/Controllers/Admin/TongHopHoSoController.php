	...
	public function loadData(Request $request)
    {
     ...
     //    $profileId = 834;
		...
		$getData = DB::table('qlhs_hosobaocao')
		    ->leftJoin('qlhs_hosobaocao as MGHP', 'MGHP.report_name', '=', DB::raw('qlhs_hosobaocao.report_name AND MGHP.report_id_truong = '.$schools_id.' AND MGHP.report_year = '.$arrYear[0].' AND MGHP.report_type like "%MGHP%"'))
		    ->leftJoin('qlhs_hosobaocao as CPHT', 'CPHT.report_name', '=', DB::raw('qlhs_hosobaocao.report_name AND CPHT.report_id_truong = '.$schools_id.' AND CPHT.report_year = '.$arrYear[0].' AND CPHT.report_type like "%CPHT%"'))
		    ->leftJoin('qlhs_hosobaocao as HTAT', 'HTAT.report_name', '=', DB::raw('qlhs_hosobaocao.report_name AND HTAT.report_id_truong = '.$schools_id.' AND HTAT.report_year = '.$arrYear[0].' AND HTAT.report_type like "%HTAT%"'))
		    ->leftJoin('qlhs_hosobaocao as HTBT', 'HTBT.report_name', '=', DB::raw('qlhs_hosobaocao.report_name AND HTBT.report_id_truong = '.$schools_id.' AND HTBT.report_year = '.$arrYear[0].' AND HTBT.report_type like "%HTBT%"'))
		    ->leftJoin('qlhs_hosobaocao as HSKT', 'HSKT.report_name', '=', DB::raw('qlhs_hosobaocao.report_name AND HSKT.report_id_truong = '.$schools_id.' AND HSKT.report_year = '.$arrYear[0].' AND HSKT.report_type like "%HSKT%"'))
		    ->leftJoin('qlhs_hosobaocao as HSDTTS', 'HSDTTS.report_name', '=', DB::raw('qlhs_hosobaocao.report_name AND HSDTTS.report_id_truong = '.$schools_id.' AND HSDTTS.report_year = '.$arrYear[0].' AND HSDTTS.report_type like "%HSDTTS%"'))
		    ->leftJoin('qlhs_hosobaocao as HTATHS', 'HTATHS.report_name', '=', DB::raw('qlhs_hosobaocao.report_name AND HTATHS.report_id_truong = '.$schools_id.' AND HTATHS.report_year = '.$arrYear[0].' AND HTATHS.report_type like "%HTATHS%"'))
		    ->leftJoin('qlhs_hosobaocao as HBHSDTNT', 'HBHSDTNT.report_name', '=', DB::raw('qlhs_hosobaocao.report_name AND HBHSDTNT.report_id_truong = '.$schools_id.' AND HBHSDTNT.report_year = '.$arrYear[0].' AND HBHSDTNT.report_type like "%HBHSDTNT%"'))
		    ->leftJoin('qlhs_hosobaocao as NGNA', 'NGNA.report_name', '=', DB::raw('qlhs_hosobaocao.report_name AND NGNA.report_id_truong = '.$schools_id.' AND NGNA.report_year = '.$arrYear[0].' AND NGNA.report_type like "%NGNA%"'))
