...
class helperClass{
 ...
 on qlhs_modules.module_id = permission_user.module_id  where module_view = :view and role_user_id = :id and module_parentid = :parent order by module_order,module_id', ['id' => $id,'view' => 1,'parent' =>$value->module_id]);
                if(count($datachild) > 0){
                  echo "<a style='padding: 15px 5px;' class='dropdown-toggle' data-toggle='dropdown' href='$value->module_path'><img alt='' src='/images/$value->module_icon' class='menu_Icon' height='20px' width='20px'> $value->module_nav <span class='caret'></span></a>";
                  ...
                  echo "<a style='padding: 15px 5px;' href='/$value->module_path'><img alt='' src='/images/$value->module_icon' class='menu_Icon' height='20px' width='20px'> $value->module_nav</a>";
                }
