...
<script type="text/javascript">
  $(function () {
    $('#btnPrint').click(function(){
        ...
        $.ajax('/ho-so/lap-danh-sach/ds-de-nghi/{{$congvan}}', {
          headers: {
                            ...
                            <div class="box-body" style="font-size:12px;max-width: 100%">
                                ...
                                <div class="col-sm-12">
                                  <select name='sltStatistic' class="form-control selectpicker" id='sltStatistic'>
                                    @if(isset($report_type) && $report_type != 'NGNA')
      ...
      <div class="modal-content box">
          ...
          <div class="box-body no-padding">
              <form class="form-horizontal" action="">
                  ...
                  @if($congvan != null && $report_type != 'NGNA')
                  <div class="box box-primary">
    ...
    <div class="box box-info">
              ...
              <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                      ...
                      <div class="col-sm-12">
                         <select name="drSchoolTHCD" id="drSchoolTHCD" class="form-control selectpicker" @if(count(explode('-',Auth::user()->truong_id)) > 1) data-live-search="true" @endif>
                         <?php 
                          $sc = null;
                         ...
                         @foreach($qlhs_schools as $val)
                            @if($id_truong == $val->schools_id || (Auth::user()->level == 1 ))
                    ...
                    <div class="col-sm-3">
                      ...
                      <div class="col-sm-12">
                        ...
                        <input type="hidden" name="TypeByCongVan" id="TypeByCongVan" value="{{$status}}">
                      </div>
                    </div>
                    <div class="col-sm-2">
                ...
                ?>
          @if($report_status == 2 || $report_status == 0)
          <div class="box box-primary">
              <div style="padding: 15px;">
                  <div class="box-header with-border" style="padding: 15px;border: 1px solid #ddd;border-radius: 5px;">
                    <p>@if($report_status == 2) <strong>Công văn bổ sung:</strong>  @elseif($report_status == 0) <strong>Công văn: </strong> @else <strong>Danh sách công văn đề nghị: </strong> @endif {{$report_text}}</p>
                    @if(isset($note) && $note != '')<p><strong>Ghi chú:</strong> {{$note}}</p>@endif
                  </div>
              </div> 
          </div>
          @endif
          <div class="box box-primary">
            ...
            <div class="box-header col-sm-2 text-center" >
                  @if($congvan != null && $report_status != 2 && $status != 2)
                  
                    <button class="btn btn-default"  onclick="openPopupDetail('{{$id_truong}}','{{$congvan}}',{{$status}},1)" id="editor_editss" title="Thông tin chi tiết"><i class='glyphicon glyphicon-eye-open'></i> Chi tiết </button>
            ...
            <!--                      <p class="menu-bottom">
                            ...
                            @else
                              @if($report_type != 'NGNA')
                                @if($status != 2 && ($report_status == 0 || $report_status == 1))
                                  <p class="menu-bottom ">
