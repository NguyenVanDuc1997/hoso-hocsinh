            ...
            @if(!empty($data))
                ...
                ?>
                    <tr>
                        ...
                        <td class='text-center' style='vertical-align:middle'>{{$value->profile_km}}</td>
                        <td class='text-center' style='vertical-align:middle'>{{$value->profile_giaothong}}</td>
                        <td class='text-right' style='vertical-align:middle'>{{number_format($value->HTBT_TA + $value->HTBT_TO + $value->HTBT_VHTT)}}</td>
                        <td class='text-right' style='vertical-align:middle'>{{number_format($value->HTBT_TA)}}</td>
                        <td class='text-right' style='vertical-align:middle'>{{number_format($value->HTBT_TO)}}</td>
                        <td class='text-right' style='vertical-align:middle'>{{number_format($value->HTBT_VHTT)}}</td>
