                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="col-sm-12">
                        <select class="form-control selectpicker" name="user_id" id="user_id">
                          ...
                          @foreach($ptc as $val)
                            <option value="{{$val->id}}" >{{$val->username}} - {{$val->last_name}}</option>
                         @endforeach
                        </select>
                      </div>
                    </div>
                ...
                <div class="form-group">
                  @if(Auth::user()->level != 1)
                    ...
                    <div class="col-sm-3">
                      ...
                      <div class="col-sm-3">
                          <label  class="col-sm-12">Cấp trường nhận</label>
                        <div class="col-sm-12">
                          <select name="sltTruong_fill" id="sltTruong_fill"  class="form-control selectpicker"  @if(count(explode('-',Auth::user()->truong_id)) > 1) data-live-search="true" @endif style="width: 100% !important">
                         <?php 
                          if(Auth::user()->truong_id !=null && Auth::user()->truong_id != 0 && Auth::user()->truong_id != '0'){
                            $qlhs_schools = DB::table('qlhs_schools')->where('schools_active',1)->whereIn('schools_id',explode('-',Auth::user()->truong_id))->select('schools_id','schools_name')->get();
                            if(count(explode('-',Auth::user()->truong_id)) > 1){
                  ...
                  <div class="col-sm-2">
                    ...
                    <select class="form-control selectpicker" id="sltUserBy">
                        @if(Auth::user()->level == 4 || Auth::user()->level == 3)
                        <option value="4" @if(Auth::user()->level == 4) selected @endif>Cấp Sở</option>
                        <option value="3" @if(Auth::user()->level == 3) selected @endif>Phòng tài chính</option>
