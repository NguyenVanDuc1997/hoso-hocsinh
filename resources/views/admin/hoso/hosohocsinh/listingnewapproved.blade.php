...
<script type="text/javascript">
  $(function () {
    ...
    $('#drSchoolTHCD').change(function() {
      ...
      loadReportBySchool($(this).val(), function(){}, 3);
    });
    $('#sltCongvan').change(function(){
        loadDanhSachDaTraLai();
       // GET_INITIAL_NGHILC();
       // loadDanhSachTraLai($('#drPagingDanhsachtonghop').val(), $('#txtSearchProfile').val());
    });
    ...
    if($('#txtSchool').val() != '' && ($('#txtSchool').val()+'').split('-').length == 1 &&  $('#txtSchool').val() != '0'){
      //alert($('#txtSchool').val());
        ...
        loadReportBySchool($('#school-per').val(), function(){}, 3);
    }
    ...
    $('#drPagingDanhsachtonghop').change(function() {
         GET_INITIAL_NGHILC();
         loadDanhSachTraLai($(this).val(), $('#txtSearchProfile').val(), $('#sltTrangthai').val());
    });

    $('#sltTrangthai').change(function() {
         GET_INITIAL_NGHILC();
         loadDanhSachTraLai($('#drPagingDanhsachtonghop').val(), $('#txtSearchProfile').val(), $(this).val());
    });
    ...
    permission(function(){
          var html_view  = '';
          var html_view_header  = '<b> Hồ sơ </b> / Danh sách từ chối phê duyệt';
              ...
              <form class="form-horizontal" action="">         
                ...
                <div class="modal-footer">
                    <div class="row text-center">
                        <button type="button" data-loading-text="Đang xử lý" class="btn btn-primary" id ="btnDuyetDSTuChoiPD">Phê duyệt</button>
                        <!-- <button type="button" data-loading-text="Đang xử lý" class="btn btn-primary" id ="btnApprovedTHCDTraLai">Trả lại</button> -->
                ...
                <!-- <div class="form-group">
                 ...
                 <div class="modal-footer">
                        <div class="row text-center" id="event-thcd">
                            ...
                            <button type="button" onclick="approvedAllDaPheDuyet()" class="btn btn-success" id ="btnApprovedDanhSachDaDuyet"><i class="glyphicon glyphicon-pencil"></i> Phê duyệt toàn bộ</button>
                            <!-- <button type="button" onclick="revertAllPheDuyet()" class="btn btn-success" id ="btnRevertDanhSachDaDuyet"><i class="glyphicon glyphicon-pencil"></i> Trả lại toàn bộ</button> -->
                        </div>
                    </div>
                  </div>
            </form>
