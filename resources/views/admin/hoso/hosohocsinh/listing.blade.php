...
<script type="text/javascript">
  $(function () {
    ...
    $('#btnImportHS').click(function(){
      // alert(($('#school-per').val()+'').split('-').length);
...
if(check_Permission_Feature('3')){
     html_view += '<a onclick="delProfileByClass()" style="margin-right: 10px" class="btn btn-success btn-xs pull-right" href="#"> <i class="glyphicon glyphicon-remove"></i> Xóa  </a>';
      ...
      if(check_Permission_Feature('1')){
        ...
        html_view += '<a href="/ho-so/hoc-sinh/danh-sach" style="margin-right: 10px" class="btn btn-success btn-xs pull-right"> <i class="glyphicon glyphicon-plus"></i> Thêm mới </a >';
    ...
    GET_INITIAL_NGHILC();
    loaddataProfile($('select#viewTableProfile').val(),$('#').val(),$('select#sltLopGrid').val(), $('#txtSearchProfile').val());
  ...
  function openModalUpdate(){
   ...
   function openModalUpto(){
      ...
      //   closeLoading();
      //   if(parseInt($('#school-per').val()) != 0 && ($('#school-per').val()+'').split('-').length <= 1){
      //       $('#drSchoolUpto').val($('#school-per').val()).selectpicker('refresh');
      //       //$('#drSchoolUpto').selectpicker('refresh');
      //   }
      ...
      <div class="modal-content box">
        ...
        <input type="hidden" class="form-control" id="txtIdRoleGroup">          
           ...
           <div class="col-sm-8">
                       ...
                       <span>- Danh sách lớp, dân tộc :<font style="color: red;font-weight: 600"> Yêu cầu nhập đúng như trong form </font></span><br/>
                    </div>
                    ...
                    <div class="box-body">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-4" style="padding-left: 0">
                          ...
                          <div class="col-sm-12" >
                            <select name="drYearUpto" disabled="disabled" id="drYearUpto"  class="form-control selectpicker" data-live-search="true" style="width: 100% !important">
                     ...
                     <div class="box-header col-sm-2">
                      ...
                      <div class="col-sm-12">
                        <select name="sltNamHoc" id="sltNamHoc" class="form-control selectpicker"  data-live-search="true">
                          <?php 
                            $history_year = DB::table('qlhs_profile_history')->select('history_year')->groupBy('history_year')->orderBy('history_year')->get();
            ...
            <div  style="font-size: 12px">
              <table id="example" class="table table-striped table-bordered table-hover dataTable no-footer">
                ...
                <tr class="success">
                  ...
                  <!-- <th class="text-center" style="vertical-align:middle">Mã học sinh</th> -->
                  <th class="text-center" style="vertical-align:middle;width: 12%">Họ và tên</th>
                  <th class="text-center" style="vertical-align:middle;width: 7%">Năm sinh</th>
                  <th class="text-center" style="vertical-align:middle;width: 6%">Dân tộc</th>
                 
                   <th class="text-center" style="vertical-align:middle;width: 20%">Hộ khẩu thường trú</th>
                    <th class="text-center" style="vertical-align:middle;width: 15%">Cha mẹ - người giám hộ</th>
                     <th class="text-center" style="vertical-align:middle;width: 8%">Lớp học </th>
                     <th class="text-center" style="vertical-align:middle;width: 9%">Năm học </th>
                     <th class="text-center" style="vertical-align:middle;width: 6%">Nhập học</th>
                     <th class="text-center" style="vertical-align:middle;width: 6%">Nghỉ học</th>
                  <th class="text-center" colspan="2" style="vertical-align:middle;width: 8%">Chức năng</th>
                </tr>
                </thead>
