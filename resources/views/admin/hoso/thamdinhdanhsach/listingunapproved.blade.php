...
<script type="text/javascript">
  $(function () {
    ...
    // loadReport();
    $('#btnApprovedTHCDTraLai').click(function(){

    });
    $('#drSchoolTHCD').change(function() {
      GET_INITIAL_NGHILC();
      loadSoCongVanDanhSachDaPheDuyet();
      loadReportBySchool($(this).val(), function(){}, 2);
    });
    $('#sltCongvan').change(function(){
        loadDanhSachDaDuyet();
       // GET_INITIAL_NGHILC();
       // loadDanhSachDaPheDuyet($('#drPagingDanhsachtonghop').val(), $('#txtSearchProfile').val());
    });
    $("#fileAttack").filestyle({
      buttonText : 'Đính kèm',
      buttonName : 'btn-info'
    });
    if($('#txtSchool').val() != '' && ($('#txtSchool').val()+'').split('-').length == 1 &&  $('#txtSchool').val() != '0'){
      //alert($('#txtSchool').val());
        loadComboxTruongHoc("drSchoolTHCD", function(){
          closeLoading();
          loadReportBySchool($('#txtSchool').val(), function(){
            $('#sltCongvan').val($('#txtCongVan').val()).trigger('change');
          }, 2);
        },$('#txtSchool').val());
        ...
        loadReportBySchool($('#school-per').val(), function(){}, 2);
    }
    ...
    $('#drPagingDanhsachtonghop').change(function() {
         GET_INITIAL_NGHILC();
         loadDanhSachDaPheDuyet($(this).val(), $('#txtSearchProfile').val(), $('#sltTrangthai').val());
    });

    $('#sltTrangthai').change(function() {
         GET_INITIAL_NGHILC();
         loadDanhSachDaPheDuyet($('#drPagingDanhsachtonghop').val(), $('#txtSearchProfile').val(), $(this).val());
    });
    ...
    permission(function(){
          var html_view  = '';
          var html_view_header  = '<b> Hồ sơ </b> / Danh sách đã được phê duyệt';
    ...
    <div class="modal-dialog modal-md" style="width: 80%;margin: 30px auto;">
      ...
      <div class="modal-content box">
        <div class="modal-header">
          ...
          <h4 class="">Phê duyệt chế độ được hưởng cho học sinh <label id="txtProfileName"></label></h4>
        </div>
        <div class="box-body no-padding">
             ...
             <!--  <div class="mailbox-read-message" style="margin-top: 10px;"> -->
              <form class="form-horizontal" action="">         
                ...
                <div class="box-body" style="font-size: 12px; overflow: auto;" id="tbApproved">
                    <!-- <table class="table table-striped table-bordered table-hover dataTable no-footer">
                        <thead>
                        <tr class="success" id="GridHeaderApprove">
                          <th  class="text-center" style="vertical-align:middle">STT</th>
                          <th  class="text-center" style="vertical-align:middle"><input type="checkbox" name="checkedAllChedo" id="checkedAllChedo"></th>
                          <th  class="text-center" style="vertical-align:middle">Tên chế độ</th>
                          <th  class="text-center" style="vertical-align:middle">Nhóm đối tượng</th>
                ...
                <div class="modal-footer">
                    <div class="row text-center">
                        <!-- <button type="button" data-loading-text="Đang xử lý" class="btn btn-primary" id ="btnApprovedTHCDPheDuyet">Phê duyệt</button> -->
                        <button type="button" data-loading-text="Đang xử lý" class="btn btn-primary" id ="btnTraLaiDSDaPD">Trả lại</button>
...
<div class="modal fade" id="myModalThuHoiHS" role="dialog">
    <div class="modal-dialog modal-md" style="width: 80%;margin: 30px auto;">
      ...
      <div class="modal-content box">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="">Thu hồi học sinh đã duyệt</h4>
        </div>
        <div class="box-body no-padding">
              ...
              <form class="form-horizontal" action="">         
                ...
                <div class="box-body" style="font-size:12px;overflow: auto ; max-width: 100%">
                    <table class="table table-striped table-bordered table-hover dataTable no-footer">
                        <thead>
                        <tr class="success" id="cmisGridHeader">
                          <th  class="text-center" style="vertical-align:middle;width: 15%;">Tên học sinh</th>
                          <th  class="text-center" style="vertical-align:middle;width: 10%;">Ngày sinh</th>
                          <!-- <th  class="text-center" style="vertical-align:middle"><input type="checkbox" name="checkedAllChedo" id="checkedAllChedo"></th> -->
                          <th  class="text-center" style="vertical-align:middle;width: 10%;">Người thu hồi</th>
                          <th  class="text-center" style="vertical-align:middle;width: 10%;">Ngày thu hồi</th>
                          <th  class="text-center" style="vertical-align:middle">Lý do thu hồi</th>
                        </tr>
                 
                      </thead>
                        <tbody id="tbThuHoiHocSinh">                     
                        </tbody>
                    </table>
                </div>
            </div>
                ...
                <div class="modal-footer">
                    <div class="row text-center">
                        <!-- <button type="button" data-loading-text="Đang xử lý" class="btn btn-primary" id ="btnApprovedTHCDPheDuyet">Phê duyệt</button> -->
                        <button type="button" data-loading-text="Đang xử lý" class="btn btn-primary" id ="btnOkThuHoi">Đồng ý</button>
                        <button type="button" class="btn btn-primary" data-dismiss="modal">Đóng</button>
                    </div>
                </div>
            </form>
                ...
                <div class="form-group">
                  <div class="col-sm-4">
                      ...
                      <div class="col-sm-8">
                        ...
                        <input type="hidden" name="txtSchool" id="txtSchool">
                      </div>
                    </div>
                     <div class="col-sm-4">
                      ...
                      <div class="col-sm-8">
                        ...
                        <input type="hidden" name="txtCongVan" id="txtCongVan">
                      </div>
                    </div>
                     <div class="col-sm-4">
                ...
                <!-- <div class="form-group">
                 ...
                 <div class="modal-footer">
                        <div class="row text-center" id="event-thcd">
                            <!-- <button type="button" data-loading-text="Đang tải dữ liệu" class="btn btn-success" id ="btnLoadDataPhong"><i class="glyphicon glyphicon-search"></i> Xem danh sách</button> -->
                            ...
                            <button type="button" onclick="revertAllDaPheDuyet()" class="btn btn-success" id ="btnRevertDanhSachDaDuyet"><i class="glyphicon glyphicon-pencil"></i> Trả lại toàn bộ</button>
                        </div>
                    </div>
                  </div>
            </form>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body" style="font-size:12px;overflow: auto ; max-width: 100%">
                  <div class="form-group " style="margin-top: 10px;margin-bottom: 10px">
                    ...
                    <table class="table table-striped table-bordered table-hover dataTable no-footer">
                        <thead>
                        <tr class="success" id="cmisGridHeaders">
