...
$(function () {
    ...
    $('#sltYear').change(function(){
        if($('#sltStatistic').val() != ""){
            // utility.message("Thông báo","Xin mời chọn loại đối tượng!",null,5000,1);
    ...
    $('#btnprn').click(function(){
        ...
        $('#btnprn').button('loading');
          var o = {
            ...
            title : $('#sltStatistic option:selected').text()
        };
        $.ajax('/bao-cao/statistic-by-history-subject-view', {
          headers: {
...
function loadStatisticTotal(){
    ...
    PostToServer('/bao-cao/statistic-by-history-subject',o,function(result){
...
<div class="box-header">
    <div class="panel-heading">
       <a href="/ho-so/lap-danh-sach/list"><b> Báo cáo</b></a> / Thống kê học sinh theo đối tượng
    </div>
                  ...
                  <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-3" style="padding-left: 0">
                                        ...
                                        <div class="col-sm-12">
                                            <select name='sltKhoiDt' class="selectpicker form-control" id='sltKhoiDt'>
                                                <option value="" selected="">-- Chọn cấp học --</option>
                    ...
                    <div class="col-sm-3">
                     ...
                     <div class="col-sm-3">
                      ...
                      <div class="col-sm-12">
                        <?php
                          $subject = \DB::table('qlhs_subject')->where('subject_code','<>','DT74-41')
                          ->where('subject_code','<>','DT49-34')->select('subject_id','subject_name')->get();
                        ?>

                        <select name='sltStatistic' multiple="" class="form-control selectpicker" id='sltStatistic'>
                          <option value="" selected="selected">-- Chọn đối tượng --</option>
                          <?php $__currentLoopData = $subject; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <option value="<?php echo e($value->subject_id); ?>"><?php echo e($value->subject_name); ?></option>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                      </div>
                    </div>
                    ...
                    <table class="table table-striped table-bordered table-hover dataTable no-footer">
                        <thead>
                          <tr class="success">
                            ...
                            <th class='text-center' style='vertical-align:middle'>Họ tên người giám hộ</th>
                          </tr>
                        </thead>
                        <tbody id="dataTongHopHoSo"></tbody>
                    </table>
