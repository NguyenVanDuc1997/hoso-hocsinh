...
<body>
 ...
 <h1 class="search-title clearfix" style="font-size: 13px;text-transform: uppercase;"><?php echo e($school); ?></h1>
        ...
        ?>
        <h1 class="search-title clearfix" style="font-size: 13px;text-align: center;font-weight: 400"><?php echo e($title); ?></h1>
        <?php endif; ?>
            ...
            <?php if(!empty($data)): ?>
                ...
                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <td style='vertical-align:middle'><?php echo e(($value->schools_name)); ?></td>
                        <td class='text-center' style='vertical-align:middle'><?php echo e(($value->hsbc_amount)); ?></td>
                        <td class='text-center' style='vertical-align:middle'><?php echo e(($value->hsbc_HSTW)); ?></td>
                        <td class='text-center' style='vertical-align:middle'><?php echo e(($value->hsbc_HSDP)); ?></td>
                        <td class='text-center' style='vertical-align:middle'><?php echo e(($value->hsbc_Total)); ?></td>
                        <td class='text-center' style='vertical-align:middle'><?php echo e(($value->hsbc_TW)); ?></td>
                        <td class='text-center' style='vertical-align:middle'><?php echo e(($value->hsbc_DP)); ?></td>
                        <td class='text-center' style='vertical-align:middle'><?php echo e(($value->hsbc_68)); ?></td>
                        <td class='text-right' style='vertical-align:middle'><?php echo e(number_format($value->hsbc_amount_TW + $value->hsbc_amount_DP)); ?></td>
                        <td class='text-right' style='vertical-align:middle'><?php echo e(number_format($value->hsbc_amount_TW)); ?></td>
                        <td class='text-right' style='vertical-align:middle'><?php echo e(number_format($value->hsbc_amount_DP)); ?></td>
