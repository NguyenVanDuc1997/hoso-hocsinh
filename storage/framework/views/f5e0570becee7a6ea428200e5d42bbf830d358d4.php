...
<script src="<?php echo asset('/mystyle/js/styleKinhPhi.js'); ?>"></script>
                        ...
                        <select name='sltTruongDt' class="form-control selectpicker" data-live-search="true" id='sltTruongDt'>
                          ...
                          <?php 
                              ...
                              <?php $__currentLoopData = $getData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> {
                                <option value="<?php echo e($value->school_type_id); ?>"><?php echo e($value->school_type_name); ?></option>
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="col-sm-6">
                        <select name='sltSubject' data-live-search="true" class="form-control selectpicker" id='sltSubject'>
                          ...
                          ?>
                           <?php $__currentLoopData = $qlhs_group; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> {
                                <option value="<?php echo e($value->group_id); ?>"><?php echo e($value->group_name); ?></option>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                         </select>
                      </div>
                    </div>
