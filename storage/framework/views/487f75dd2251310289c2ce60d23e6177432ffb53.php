                ...
                <form class="form-horizontal">
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-sm-6" style="padding-left: 0">
                            ...
                            <div class="col-sm-12" style="padding-right: 0;padding-left: 0;">
                                <select name="sltTruong" id="sltTruong" disabled="disabled" class="form-control selectpicker" <?php if(count(explode( '-',Auth::user()->truong_id)) > 1): ?> data-live-search="true" <?php endif; ?> style="width: 100% !important">
                                    <?php 
        ...
        ?>
                                            ...
                                            <?php 
                                                ...
                                                <optgroup label='Năm học <?php echo e($nam->name); ?>'>
                                                    ...
                                                    <option value="<?php echo e($hk->qlhs_hocky_value); ?>" <?php if(trim($hk->qlhs_hocky_value) == trim($str_date)): ?> selected="selected" <?php endif; ?>><?php echo e($hk->qlhs_hocky_name); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </optgroup>
                                                <?php }?>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
