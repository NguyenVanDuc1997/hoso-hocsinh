<?php $__env->startSection('title', 'Đăng nhập - Phần mềm quản lý hồ sơ'); ?>
...
<!--         <iframe  id="mainFrame" name="mainFrame" class="ui-layout-center"
  src="http://thuxahoihoa.revosoft.vn/admin/login"></iframe>    -->
        <div class="card card-container">
            <form id="myLogin" class="form-signin" method="POST" action="<?php echo e(url('/login')); ?>">
               <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                <input type="text" id="username" name="username" class="form-control ui-autocomplete-input" placeholder="Tên đăng nhập" value="<?php echo e(old('username')); ?>" required autofocus>
                ...
                <button class="btn btn-lg btn-primary btn-block btn-signin" id="btn-signin" onclick="my_login()" type="button">Đăng nhập</button>
            </form><!-- /form -->
            <a href="<?php echo e(url('/password/reset')); ?>" class="forgot-password">Quên mật khẩu?</a><!--  or <a href="<?php echo e(url('/username/reminder')); ?>" class="forgot-password">Quên tài khoản đăng nhập?</a> -->
        </div><!-- /card-container -->
