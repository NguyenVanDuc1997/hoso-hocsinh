...
<script src="<?php echo asset('mystyle/js/styleKinhPhi2.js'); ?>"></script>
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="col-sm-6">
                        <select name='sltKhoiDt' class="form-control selectpicker" id='sltKhoiDt' data-live-search="true">
                          ...
                          ?>
                          <?php $__currentLoopData = $arrUnit; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> {
                               <option value="<?php echo e($value->unit_id); ?>"><?php echo e($value->unit_name); ?></option>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                      </div>
                    </div>
