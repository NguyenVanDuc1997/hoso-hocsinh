            ...
            <?php if(!empty($data)): ?>
                ...
                ?>
                    <tr>
                        ...
                        <?php $c = explode('|',$cd); ?>
                            <?php if($check && ($c[0] == 89 || $c[0] == 90 || $c[0] == 91)): ?>
                            <?php $check = false; ?>
                                <?php if(isset($c[3]) && $c[3] == 35): ?>
                                <?php $v35++; ?>
                                ...
                                <td class='text-center' style='vertical-align:middle'></td>
                                <?php endif; ?>
                                <?php if(isset($c[3]) && $c[3] == 100): ?>
                                <?php $v100++; ?>
                                <td class='text-center' style='vertical-align:middle'>x</td>
                                <?php else: ?>
                                <td class='text-center' style='vertical-align:middle'></td>
                                <?php endif; ?>
                                <?php if(isset($c[3]) && $c[3] == 101): ?>
                                <?php $v101++; ?>
                                <td class='text-center' style='vertical-align:middle'>x</td>
                                <?php else: ?>
                                <td class='text-center' style='vertical-align:middle'></td>
                                <?php endif; ?>
                                <?php if(isset($c[3]) && $c[3] == 40): ?>
                                <?php $v40++; ?>
                                <td class='text-center' style='vertical-align:middle'>x</td>
                                <?php else: ?>
                                <td class='text-center' style='vertical-align:middle'></td>
             ...
             <!--            <td class='text-right' style='vertical-align:middle'>-</td> -->
                        <td class='text-right' style='vertical-align:middle'><?php echo e(number_format($value->MGHP)); ?></td>
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                        <th class='text-center' colspan="9" style='vertical-align:middle'>Tổng</th>
                        <th class='text-center' style='vertical-align:middle'><?php echo e($v35); ?></th>
                        <th class='text-center' style='vertical-align:middle'><?php echo e($v38); ?></th>
                        <th class='text-center' style='vertical-align:middle'><?php echo e($v39); ?></th>
                        ...
                        <th class='text-center' style='vertical-align:middle'><?php echo e($v100); ?></th>
                        <th class='text-center' style='vertical-align:middle'><?php echo e($v101); ?></th>
                        <th class='text-center' style='vertical-align:middle'><?php echo e($v40); ?></th>
