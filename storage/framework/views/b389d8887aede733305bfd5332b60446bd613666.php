...
<section class="content">
                  ...
                  <div class="box-body">
                     <div class="form-group">
                        <div class="col-sm-3" style="padding-left: 0">
                           ...
                           <div class="col-sm-12">
                              <select name="drSchoolUpto" id="drSchoolUpto" class="form-control selectpicker" <?php if(count(explode('-',Auth::user()->truong_id)) > 1): ?> data-live-search="true" <?php endif; ?> style="width: 100% !important">
                              <?php
                        ...
                        <div class="col-sm-2" style="padding-left: 0">
                           ...
                           <div class="col-sm-12" >
                              ...
                              <?php $__currentLoopData = $history_year; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(trim($val->history_year) == trim($str_date)): ?>
                                  <option value="<?php echo e($val->history_year); ?>" selected="selected"><?php echo e($val->history_year); ?></option>
                                <?php else: ?>
                                  <option value="<?php echo e($val->history_year); ?>"><?php echo e($val->history_year); ?></option>
                               <?php endif; ?>

                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                              </select>
                              <input type="hidden" name="timenow" id="timenow" value="<?php echo e(trim($str_date)); ?>">
                           </div>
                        </div>
                        <div class="col-sm-2" style="padding-left: 0">
   ...
   <div class="box box-primary">
      ...
      <div class="box-header col-sm-3">
         ...
         <div class="col-sm-12">
            <select name="sltTruongGrid" id="sltTruongGrid" class="form-control selectpicker" <?php if(count(explode('-',Auth::user()->truong_id)) > 1): ?> data-live-search="true" <?php endif; ?>>
            <?php
               if(Auth::user()->truong_id !=null && Auth::user()->truong_id != 0 && Auth::user()->truong_id != '0'){
                 $qlhs_schools = DB::table('qlhs_schools')->where('schools_active',1)->whereIn('schools_id',explode('-',Auth::user()->truong_id))->select('schools_id','schools_name')->get();
                 if(count(explode('-',Auth::user()->truong_id)) > 1){
      ...
      <div class="box-header col-sm-2">
         ...
         <div class="col-sm-12">
            ...
            <?php $__currentLoopData = $history_year; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($val->history_year); ?>" <?php if(trim($val->history_year) == trim($str_date)): ?> selected <?php endif; ?>><?php echo e($val->history_year); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
         </div>
      </div>
