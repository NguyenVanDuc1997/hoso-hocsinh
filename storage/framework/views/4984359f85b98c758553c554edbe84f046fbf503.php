                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">                    
                    <select id="drGroupSubject"  multiple="multiple"  class="selectpicker form-control" data-actions-box="true" data-live-search="true" multiple data-selected-text-format="count">
                      ...
                      ?>
                       <?php $__currentLoopData = $qlhs_group; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($val->group_id); ?>"><?php echo e($val->group_name); ?></option>
