...
<script type="text/javascript">
  $(function () {
    ...
    $('#drPagingDanhsach').change(function() {
      GET_INITIAL_NGHILC();
      loadTongHopCongVanBySchool($('#sltSchools').val(),$('#txtSearchProfileLapdanhsach').val());
    });

    $('#sltSchools').change(function() {
      GET_INITIAL_NGHILC();
      loadTongHopCongVanBySchool($(this).val(),$('#txtSearchProfileLapdanhsach').val());
    });
                  ...
                  <div class="col-sm-3 box-header">
                      ...
                      <div class="col-sm-12">
                        <select name='sltLoaiCV' class="selectpicker form-control" id='sltLoaiCV'>
                            <option value="1" selected="selected">Công văn phê duyệt / thu hồi</option>
